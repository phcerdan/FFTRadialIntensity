...
filename =  "./singleImagesFromPectin/pMEAN"
...
I = data[,"I"];
datf = data.frame(q,I);
datf_trim = subset(datf);
# datf_trim = subset(datf, subset=datf$q > 10^-2.1);
# # Second set:
# filename =  "./pectinHomogeneousBinaryOtsuLocal.plot"
# data2 = read.table(filename, col.names=c("d", "I"), row.names=NULL);
# q2 = data2[,"d"] * df / Nmin;
# I2 = data2[,"I"];
