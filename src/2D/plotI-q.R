...
#####tikzDevice
library("tikzDevice")
latexroot="~/devtoolset/texlive/2014/bin/x86_64-linux/"
...
#data = datf, aes(x = q, y = I)) + theme_bw() + # white background
p <-ggplot()+
    theme_bw() +
    # remove minor ticks
    ...
    # labs(title=expression(tikzName), x=expression("q " ~ nm^{-1} ~""), y=expression("I"))
